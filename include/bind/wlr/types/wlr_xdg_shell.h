...
struct wlr_xdg_toplevel_state {
  ...
  //struct wlr_listener fullscreen_output_destroy;
};
...
void wlr_xdg_popup_get_anchor_point(struct wlr_xdg_popup *popup,
		___out int *toplevel_sx, ___out int *toplevel_sy);
...
void wlr_xdg_popup_get_toplevel_coords(struct wlr_xdg_popup *popup,
		int popup_sx, int popup_sy, ___out int *toplevel_sx, ___out int *toplevel_sy);
...
struct wlr_surface *wlr_xdg_surface_surface_at(
		...
		___out double *sub_x, ___out double *sub_y);
